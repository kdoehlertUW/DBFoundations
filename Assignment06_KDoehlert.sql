...
-- 2022-05-23,KDoehlert,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_KDoehlert')
	 Begin 
	  Alter Database [Assignment06DB_KDoehlert] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_KDoehlert;
	 End
	Create Database Assignment06DB_KDoehlert;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_KDoehlert;
...
AS
 ...
 --NOTE: I included Manager Name per instructions above even though it is not listed in the example rows below
